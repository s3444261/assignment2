...
<div class="row">
	<div
		...
		<form class="form-inline" method="post"
			action="Funds-Transfer-Payee-List">
			<div class="row marginTop20">
				<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">Account Name:</div>
				<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">G. Kinkead Cheque
					Account</div>
			</div>
			<div class="row marginTop20">
			...
			<div class="row marginTop20">
				...
				<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">086547</div>
			</div>
			<div class="row marginTop20">
				<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">Account Number:</div>
				<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">55478862</div>
			</div>
			<div class="row marginTop20">
