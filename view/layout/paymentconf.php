		...
		<div class="row">
			<div class="col-md-12 padding20">
				<form class="form-inline" method="post"
					action="Bill-Payment-Acknowledgement">
					...
					<div class="conf col-xs-3 col-sm-3 col-md-2 col-lg-2">Biller
						Nickname:</div>
					...
					?></div>
					<div class="conf col-xs-12 col-sm-12 col-md-12 col-lg-12 note">This
						biller is FAB authorised.</div>
					<div class="conf col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">Enter
						your Internet Banking Password.</div>
					...
					<div
						class="conf col-xs-12 col-sm-12 col-md-12 col-lg-12 note marginTop20">Bill
						payments made before 6.30pm AEST/AEDT are processed in 1 business
						day in most cases.</div>
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 textRight">
						<a href="Bill-Payment-Amount" class="btn btn-primary"
							role="button">Back</a>
